...
import DeleteUserButton from "../../general/generalElements/DeleteButton";
import ChangeUserInfoButton from "../../general/generalElements/ChangeInfoButton";
      ...
      >
        ...
        >
          ...
          <tfoot>
            ...
            <tr>
              <td style={{ width: "50%" }}>
                <DeleteUserButton username={String(userData.username)} />
              </td>
              <td>
                <ChangeUserInfoButton username={String(userData.username)} />
              </td>
            </tr>
          </tfoot>
        </table>
